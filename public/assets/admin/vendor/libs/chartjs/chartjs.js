...
!(function (t, e) {
  ...
  return (function () {
        ...
        if (((d = i[l]), null == d || I(d))) {
          if (I(d))
            for (h = 0, c = d.length; h < c; h++)
              (u = d[h]), null == u || I(u) || (a = se(t, n, o, a, u));
        } else a = se(t, n, o, a, d);
      t.restore();
      const f = o.length / 2;
      if (f > i.length) {
      ...
      for (n = 0, o = t.length; n < o; ++n)
        if (
          ...
          void 0 !== a &&
            ...
            void 0 !== i && I(a) && ((a = a[i % a.length]), (r = !1)),
            void 0 !== a))
        )
              ...
              return (
                tt(r) &&
                  ...
                  (r = (function (t, e, i, s) {
                    ...
                    let l = e(o, a || s);
                    return (
                      r.delete(t), Ee(t, l) && (l = Ve(n._scopes, n, t, l)), l
                    );
                  })(e, r, t, i)),
                I(r) &&
                  r.length &&
    ...
    function Ve(t, e, i, s) {
      ...
      return (
        null !== l &&
        (void 0 === o || o === i || ((l = Be(r, a, o, l, s)), null !== l)) &&
        Ce(Array.from(r), [""], n, o, () =>
          (function (t, e, i) {
        ...
        (m = e[t % a]),
          m.skip ||
            ...
            p !== b &&
              ...
              null !== _ &&
                (!x || 0 === r(o, p) || l(o, b, p)) &&
                (g.push(gi({ start: _, end: t, loop: u, count: a, style: f })),
                (_ = null)),
              (i = t),
              (b = p)));
      return (
        null !== _ &&
          g.push(gi({ start: _, end: d, loop: u, count: a, style: f })),
        g
      );
    }
    function mi(t, e) {
    ...
    class zi {
      ...
      parseObjectData(t, e, i, s) {
        ...
        for (h = 0, c = s; h < c; ++h)
          (d = h + i),
            (u = e[d]),
            (l[h] = { x: n.parse(Z(u, a), d), y: o.parse(Z(u, r), d) });
        return l;
      }
      getParsed(t) {
      ...
      applyStack(t, e, i) {
        const s = this.chart,
          ...
          o = e[t.axis];
        return Di(
          { keys: Pi(s, !0), values: e._stacks[t.axis]._visualValues },
          o,
          n.index,
          { mode: i }
        );
      ...
      updateRangeFromParsed(t, e, i, s) {
        ...
        s && a && ((s.values = a), (o = Di(s, n, this._cachedMeta.index))),
      ...
      _resolveElementOptions(t, e = "default", i) {
        ...
        return (
          f.$shared && ((f.$shared = r), (n[o] = Object.freeze(Ii(f, r)))), f
        );
      }
          ...
          { circumference: d, rotation: u } = this._getRotationExtents(),
          {
            ...
            if (e < st) {
              const r = t,
                ...
                u = Math.sin(l),
                f = (t, e, s) =>
                  wt(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
                g = (t, e, s) =>
                  wt(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i),
                p = f(0, h, d),
                m = f(rt, c, u),
                b = g(it, h, d),
                x = g(it + rt, c, u);
          ...
          for (let u = e; u < e + i; u++) {
            const e = this.getParsed(u),
              ...
              p = {
                ...
                base: i.base,
                enableBorderRadius:
                  !g || Wi(e._custom) || o === g._top || o === g._bottom,
                x: l ? i.head : f.center,
                y: l ? f.center : i.head,
    ...
    function fs(t, e, i, s) {
      ...
      for (const r of t) {
        ...
        if (r.horizontal) {
          ...
          Q(l.start) && (a = l.start),
            t.fullSize
              ? us(t, n.left, a, i.outerWidth - n.right - n.left, o)
          ...
          Q(l.start) && (o = l.start),
            t.fullSize
              ? us(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
    ...
    class Ns extends Ls {
          ...
          o.display &&
            ...
            ((this.ticks = (function (t, e) {
              ...
              if (a > 0) {
                ...
                for (
                  Es(e, h, c, R(s) ? 0 : r - s, r), t = 0, i = a - 1;
                  t < i;
                  t++
                )
                  Es(e, h, c, o[t], o[t + 1]);
      ...
      generateTickLabels(t) {
        ...
        let i, s, n;
        for (i = 0, s = t.length; i < s; i++)
          (n = t[i]), (n.label = N(e.callback, [n.value, i, t], this));
      }
      ...
      calculateLabelRotation() {
        ...
        (o = t.offset ? this.maxWidth / i : u / (i - 1)),
          c + 6 > o &&
            ...
            (l = bt(
              Math.min(
                Math.asin(kt((h.highest.height + 6) / o, -1, 1)),
                Math.asin(kt(a / r, -1, 1)) - Math.asin(kt(d / r, -1, 1))
              )
            )),
      ...
      fit() {
        ...
        if (o) {
          ...
          if (
            (a
              ? ((t.width = this.maxWidth), (t.height = Vs(n) + o))
              : ((t.height = this.maxHeight), (t.width = Vs(n) + o)),
        ...
        for (l = 0; l < e; l += r) {
          if (
            ...
            if (I(d))
              for (h = 0, c = d.length; h < c; ++h)
                (x = d[h]),
                  R(x) || I(x) || ((m = se(s, g.data, g.gc, m, x)), (b += p));
    ...
    class Hs {
      ...
      unregister(t) {
        const e = this.items,
          ...
          s = this.scope;
        i in e && delete e[i],
          s && i in ie[s] && (delete ie[s][i], this.override && delete Zt[i]);
      }
    }
    class js {
      constructor() {
          ...
          ? (function (t, { plugins: e, localIds: i }, s, n) {
              ...
              for (const r of e) {
                ...
                null !== l &&
                  o.push({
                    plugin: r,
                    options: Xs(t.config, { plugin: r, local: i[e] }, l, a),
                  });
              }
              return o;
            })(t, n, s, e)
          ...
          return (
            Object.keys(s).forEach((e) => {
              ...
              const r = Gs(
                ...
                h = i.scales || {};
              o[e] = q(Object.create(null), [{ axis: r }, a, h[r], h[l]]);
            }),
    ...
    const rn = (t) =>
        z(t) && Object.getOwnPropertyNames(t).some((e) => tt(t[e])),
    ...
    function En(t, e, i, s) {
      const n = null === e,
        ...
        a = t && !(n && o) && Tn(t, s);
      return (
        a && (n || St(e, a.left, a.right)) && (o || St(i, a.top, a.bottom))
      );
    }
    function Rn(t, e) {
          ...
          return (i, s) => {
            ...
            n instanceof Yi
              ...
              : n &&
                (e = (function (t, e) {
                  return (
                    (t.borderColor = Bn(e)), (t.backgroundColor = Wn(e)), ++e
                  );
                })(i, e));
          };
        })(t);
        ...
        (function (t, e) {
          ...
          t.save(),
            "x" === l &&
              o !== n &&
              (so(t, s, a.top),
              no(t, { line: i, target: s, color: n, scale: r, property: l }),
              t.restore(),
              t.save(),
              so(t, s, a.bottom)),
            no(t, { line: i, target: s, color: o, scale: r, property: l }),
            t.restore();
        })(t, {
          line: n,
          target: s,
      ...
      afterDatasetsUpdate(t, e, i) {
        ...
        for (a = 0; a < s; ++a)
          (o = t.getDatasetMeta(a)),
            ...
            n.push(l);
        for (a = 0; a < s; ++a)
          (l = n[a]), l && !1 !== l.fill && (l.fill = Zn(n, a, i.propagate));
      },
      beforeDraw(t, e, i) {
          ...
          if (
            ...
            m
              ? y > 0 &&
                ...
                ((S = u.y += x),
                u.line++,
                (k = u.x = It(n, this.left + h, this.right - i[u.line])))
              : y > 0 &&
                S + x > this.bottom &&
                ((k = u.x = k + e[u.line].width + h),
                u.line++,
                (S = u.y =
                  It(n, this.top + b + h, this.bottom - e[u.line].height))),
            (function (t, e, i) {
      ...
      _drawArgs(t) {
        ...
        return (
          this.isHorizontal()
            ...
            : ("left" === o.position
                ? ((l = i + t), (h = It(a, s, e)), (c = -0.5 * it))
                : ((l = n - t), (h = It(a, e, s)), (c = 0.5 * it)),
              (r = s - e)),
    ...
    var go = {
      ...
      start(t, e, i) {
        !(function (t, e) {
          const i = new fo({ ctx: t.ctx, options: e, chart: t });
    ...
    var mo = {
      id: "subtitle",
      start(t, e, i) {
        const s = new fo({ ctx: t.ctx, options: i, chart: t });
    ...
    function ko(t, e, i, s) {
      ...
      return (
        ...
        { x: kt(g, 0, s.width - e.width), y: kt(p, 0, s.height - e.height) }
      );
    }
    function So(t, e, i) {
        ...
        if (n.usePointStyle) {
          ...
          Object.values(a).some((t) => 0 !== t)
            ? (t.beginPath(),
              ...
              (t.fillStyle = o.backgroundColor),
              t.beginPath(),
              be(t, { x: i, y: f + 1, w: l - 2, h: r - 2, radius: a }),
              t.fill())
            : ((t.fillStyle = n.multiKeyBackground),
              t.fillRect(e, f, l, r),
      ...
      drawBody(t, e, i) {
        ...
        for (
          e.textAlign = o,
            ...
            H(this.beforeBody, g),
            u =
              a && "right" !== p ? ("center" === o ? l / 2 + h : l + 2 + h) : 0,
            _ = 0,
            v = s.length;
          _ < v;
          ++_
    ...
    var To = {
        ...
        positioners: bo,
        afterInit(t, e, i) {
          i && (t.tooltip = new Ao({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
      ...
      buildTicks() {
        ...
        const s = (function (t, e) {
          ...
          (w = Math.ceil(p / k) - Math.floor(g / k)),
            w > f && (k = ft((w * k) / f / u) * u),
            R(r) || ((y = Math.pow(10, r)), (k = Math.ceil(k * y) / y)),
            "ticks" === s
          ...
          for (
            ...
            (d && v !== o
              ? (i.push({ value: o }),
                v < o && P++,
                ut(Math.round((v + P * k) * y) / y, o, Ro(o, _, t)) && P++)
              : v < o && P++);
            P < w;
            ++P
          ) {
          ...
          return (
            b && d && M !== a
              ? i.length && ut(i[i.length - 1].value, a, Ro(a, _, t))
    ...
    class No extends Ns {
      ...
      static defaults = {
        ticks: { callback: Gt.formatters.logarithmic, major: { enabled: !0 } },
      };
      constructor(t) {
        super(t),
          (this.start = void 0),
      ...
      buildTicks() {
        const t = this.options,
          e = (function (t, { min: e, max: i }) {
            ...
            for (; u < i; )
              s.push({ value: u, major: Bo(u), significand: d }),
                d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
                d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
                (u = Math.round((l + c + d * Math.pow(10, o)) * a) / a);
            const f = V(t.max, u);
            return s.push({ value: f, major: Bo(f), significand: d }), s;
      ...
      getLabelForValue(t) {
        return void 0 === t
          ? "0"
          : qt(t, this.chart.options.locale, this.options.ticks.format);
      }
      configure() {
        const t = this.min;
        super.configure(),
        ...
        return (
          ...
          null === t || isNaN(t)
            ...
            : this.getPixelForDecimal(
                t === this.min
                  ? 0
                  : (ct(t) - this._startValue) / this._valueRange
              )
        );
      }
      getValueForPixel(t) {
              ...
              for (let d = 0; d < o; d++) {
                ...
                const u = t.getPointPosition(d, t.drawingArea + n[d], r),
                  ...
                  g =
                    ...
                    { w: ne(l, h.string, c), h: c.length * h.lineHeight });
                s[d] = g;
              ...
              t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                (t._pointLabelItems = (function (t, e, i) {
                  const s = [],
                    ...
                    l = { extra: Ho(o) / 2, additionalAngle: a ? it / n : 0 };
                  let h;
                  for (let o = 0; o < n; o++) {
                    ...
                    s.push(n),
                      "auto" === r &&
                        ((n.visible = Uo(n, h)), n.visible && (h = n));
                  }
                  return s;
                })(t, s, n));
            })(this)
    ...
    class sa extends Ns {
      ...
      buildTicks() {
        ...
        return (
          (this._unit =
            e.unit ||
            (i.autoSkip
              ? ta(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
              : (function (t, e, i, s, n) {
      ...
      _generate() {
        ...
        return (
          (c !== i && "ticks" !== s.bounds && 1 !== d) || ea(h, c, f),
          Object.keys(h)
            .sort(Jo)
            .map((t) => +t)
        );
    ...
    var oa = Object.freeze({
      ...
      CategoryScale: class extends Ns {
        ...
        parse(t, e) {
          ...
          return ((t, e) => (null === t ? null : kt(Math.round(t), 0, e)))(
            (e =
              isFinite(e) && i[e] === t
                ? e
                : (function (t, e, i, s) {
