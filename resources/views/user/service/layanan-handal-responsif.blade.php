...
@section('title', 'Layanan Handal Dan Responsif')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5 mt-md-50 mt-xs-50 pl-30 pl-md-15 pl-xs-15 services-sidebar">
                        ...
                        <div class="single-widget services-list-widget">
                            ...
                            <ul>
                                <li><a href="services-details.html">Advanced online appointment <i class="fas fa-angle-right"></i></a></li>
                                <li class="current-item"><a href="services-details.html">Easy team management <i class="fas fa-angle-right"></i></a></li>
                                <li><a href="services-details.html">Multiple user & management <i class="fas fa-angle-right"></i></a></li>
                                <li><a href="services-details.html">Editable & highly customizable <i class="fas fa-angle-right"></i></a></li>
                                <li><a href="services-details.html">Superfast cloud data saved <i class="fas fa-angle-right"></i></a></li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
                    </div>
